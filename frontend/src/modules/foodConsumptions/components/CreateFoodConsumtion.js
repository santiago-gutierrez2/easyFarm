    ...
    return (
        <>
            <Breadcrumb>
                ...
                <Breadcrumb.Item href="/foodConsumption/AllFoodConsumptions">Food consumptions list</Breadcrumb.Item>
                <Breadcrumb.Item active>Register new consumption</Breadcrumb.Item>
            </Breadcrumb>
                        ...
                        <div className="card-body">
                            <form ref={node => form = node}
                                ...
                                <div className="form-group row">
                                    ...
                                    <div className="col-md-6">
                                        <MultiSelect id="animals" required options={animalsOptions}
                                                     value={animalsSelected} onChange={setAnimalsSelected}
                                                     labelledBy="Select"/>
